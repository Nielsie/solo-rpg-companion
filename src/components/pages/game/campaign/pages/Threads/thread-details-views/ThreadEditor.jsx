import {Card, IconButton, Input, Stack, Switch, Typography} from "@mui/joy";
import CheckIcon from '@mui/icons-material/Check';
import CancelIcon from '@mui/icons-material/Cancel';
import {useState} from "react";

export const ThreadEditor = props => {
    ...
    const onToggleClick = event => setIsInProgress(event.target.checked);
